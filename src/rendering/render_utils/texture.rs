use std::rc::Rc;
use wgpu::{BindGroup, BindGroupLayout, Extent3d, ShaderStages, TextureFormat, TextureUsages};
...
impl Texture {
	pub fn new(device: &wgpu::Device, size: wgpu::Extent3d, format:TextureFormat, usage: TextureUsages, visibility: ShaderStages, name: &str) -> Self {
		let texture = device
